    ...
    <section id="home" className="relative overflow-hidden border-b-[3px] border-ink conic-pattern">
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 md:grid-cols-2 md:px-8 md:py-28">
        <div className="relative">
          ...
          <h1 className="mt-6 font-display text-4xl sm:text-5xl leading-[0.95] md:text-6xl lg:text-7xl xl:text-8xl uppercase tracking-tight break-normal">
            Summer
            <br />
        ...
        <div className="relative p-2 md:p-6">
          ...
          <div className="relative w-full border-[3px] border-ink bg-card p-6 shadow-brutal-lg flex items-center justify-center">
