...
export function Domains() {
  ...
  const allDomains = Array.from(new Set(events.flatMap((e) => e.domains))).sort(
  ...
  return (
    <section
      id="domains"
      className="border-b-[3px] border-ink bg-accent/5 py-20 relative overflow-hidden"
    >
      <style>{`
        @keyframes scaleUp {
          0% {
            ...
            {allDomains.map((dom) => {
              ...
              return (
                ...
                >
                  <span>{dom}</span>
                  <span
                    className={`px-1.5 py-0.5 text-[9px] font-mono border ${isActive ? "border-primary-foreground bg-primary-foreground/20 text-primary-foreground" : "border-ink bg-peach text-ink font-bold"}`}
                  >
                    {count}
                  </span>
                </button>
        ...
        <div>
          <div className="mb-6 flex items-center gap-3">
            <span className="border-[2px] border-ink bg-accent px-3 py-1 font-display text-xs uppercase shadow-brutal-sm">
              Matches: {matchingEvents.length} Problem Statement
            ...
            {matchingEvents.map((e, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <div
                    className="mt-5 flex items-center justify-between border-t-[2px] border-ink pt-3"
                    ...
                    <div className="flex gap-2">
                      ...
                      {e.regLink && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="grid h-8 w-8 place-items-center border-[2px] border-ink bg-[#FFD700] text-ink shadow-brutal-xs transition-transform hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none active:translate-x-0 active:translate-y-0 cursor-pointer select-none"
