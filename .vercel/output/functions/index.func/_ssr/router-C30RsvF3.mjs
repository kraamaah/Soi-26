...
const appCss = "/assets/styles-BIRO4jA5.css";
...
const $$splitComponentImporter = () => import("./index-CIk4Odit.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "The seventh edition of Summer of Innovation: two months, eighteen technical challenges across AI, robotics, design, motorsports, finance and space."
    }, {
      property: "og:title",
      content: "Summer of Innovation'26"
    }, {
      property: "og:description",
      content: "Eighteen challenges, two months, one summer of building. Join the seventh edition."
    }]
  }),
